...
print(f"\nVotos totais: {numero}\nVotos brancos em relação ao total: {(100 * votos_brancos)/numero:.2f}%\nVotos nulos em relação ao total: {(100 * votos_nulos)/numero:.2f}%\nVotos validos em relação ao total: {(100 * votos_validos)/numero:.2f}%")
